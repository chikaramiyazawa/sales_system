        ...
        if(_token != null && _token.equals(request.getSession().getId())){
           ...
           price = price * counter ;
            ...
            s.setRecode(currentTime);
                ...
                request.getSession().setAttribute("flush", "購入しました。");
                em.close();

                response.sendRedirect(request.getContextPath() + "/products/buy/index");
            }
        }
    }
